...
/**
 * @brief This function is an event handler that is called when the widget needs to be painted.
 * 
 * @param event A pointer to the QPaintEvent object that contains the event parameters.
 */
